...
//     if (true) {
//         let a = "Hello"; // New value assigned because let has override the value
//         console.log(a);  // which is doing the legal shadwoing
//     }
...
//     if (true) {
//         let a = "Hi"; // Legal Shadowing var se let ko shawdow hota he
//         var b = "Bye"; // Illegal Shadowing but let se var ka shadow nahi hota he
